...
3. Added a session-only PiP auto-dock button that smoothly hides on pointer leave, keeps a 40 px edge strip visible, restores on pointer enter, and is mutually exclusive with mouse passthrough
