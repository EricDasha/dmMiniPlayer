...
import AutoDockButton from './bottomPanel/AutoDockButton'
...
const VideoPlayerV2Inner = observer(
    ...
    const el = (
      <div
        ...
        className={classNames(
          'video-player-v2 relative isolate overflow-hidden select-none wh-[100%] group',
          props.className,
  ...
  .video-player-v2.mouse-passthrough .side-dragger {
    pointer-events: auto !important;
        ...
        <div
          className={classNames(
            'video-action-area w-full z-[10] transition-all duration-500',
        ...
        >
          ...
          <div className="group-[&.active]:!opacity-100 opacity-0 transition-all duration-500">
            ...
            <div className="actions text-white px-5 py-2 f-i-center relative z-[6] gap-3 h-area-height">
              ...
              <div className="right ml-auto f-i-center gap-1">
                {configStore.bp_autoDock && <AutoDockButton />}
        ...
        <DanmakuContainer />
        <div className="relative z-[3] group-[&.active]:opacity-0 transition-all">
